...
DEMO_STEPS = [
    ("1", "故事导入", "从原始纪要、口述故事、参考链接中提取主线、人物、年代、关键道具和结尾情绪。"),
    ("2", "PRD定方向", "确认平台、横竖版策略、集数、时长、现实线和故事线，先把项目边界定清。"),
    ("3", "分集剧本", "把完整故事拆成分集剧本，保证主角、称呼、因果和悬念连续。"),
    ("4", "分集分镜", "每集拆成可画镜头，标清景别、画面、台词、音效、运镜和生成难度。"),
    ("5", "成本核算", "估算图生视频付费秒数，判断全片先做是否划算。"),
    ("6", "剪辑先行", "从正片里抽取高光镜头，重新生成预告剪辑剧本和预告分镜。"),
    ("7", "定版资产", "固定角色、道具、场景、年代服装和视觉风格母版。"),
    ("8", "横版静帧", "生成16:9静帧，先保证画面资产统一可看。"),
    ("9", "镜头分级", "S/A镜头试图生视频，B/C镜头走静帧动效。"),
    ("10", "付费兜底", "Seedance只补低成本平台失败的核心爆点，不扩大到普通镜头。"),
    ("11", "粗剪合成", "合并视频、静帧动效、字幕、旁白、音效，形成横版母版。"),
    ("12", "验收交付", "检查剧情、角色、道具、字幕、安全区和预算，再导出横版与竖版。"),
]
...
<body>
  <main class="wrap">
    ...
    <h2>02 · 点击节点查看详细流程</h2>
    <p class="caption">点击上方任一模块，下面会展开该节点的具体动作、产物和下一步。面试时不用再打开复杂脑图。</p>
    ...
    <h2>03 · 故事到成片完整流程</h2>
    <p class="caption">这条线展示从一个故事素材，如何一步步变成可发布的横版预告和竖版短视频。</p>
