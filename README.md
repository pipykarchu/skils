...
| `dingzhuangzao` | 想做漫剧角色定妆、角色正面肖像候选、Gemini/Image2/MJ 提示词、统一视觉评审网页、多选标心、锁脸/身体/衣服/发型、确认造型后三视图高清导出和总览拼图时使用。它会先读取世界观、年代设定、场景和角色资料，服装造型必须贴合项目设定。 | `$dingzhuangzao 读取这个漫剧项目的世界观和角色设定，先给每个角色生成四张正面定妆候选并做统一视觉评审页` |
