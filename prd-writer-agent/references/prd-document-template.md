...
| 成本估算公式 | 预估金额 = 预估输入 tokens * 输入单价 + 预估输出 tokens * 输出单价 + 其他计费项 | 待确认 |
| 产出估算口径 | 按文档、功能、页面、接口、测试、脚本、提示词、可复用资产和业务/效率收益拆分 | 待确认 |
...
| 日期/阶段 | 产出类型 | 实际产出 | 数量 | 验收结果 | 关联需求/里程碑 | 价值口径 | 数据来源 | 备注 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [日期/阶段] | 文档/功能/页面/测试/资产 | 待统计 | 待统计 | 待确认 | [编号] | [口径] | [来源] | [说明] |
